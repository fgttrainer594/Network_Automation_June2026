...
REPORT_FILE = "automation_report_fortigate.csv"
LOG_FILE = "automation_fortigate.log"
VENDOR = "FortiGate"
...
log_and_print(
    "INFO",
    "Starting FortiGate integrated automation workflow",
)
    ...
    with open(
        ...
        for line_number, row in enumerate(
            ...
            if verify_success:
                ...
                #
                # This prevents another row in the same CSV
                # from creating the same object again.
                # -----------------------------------------
